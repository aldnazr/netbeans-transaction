...
SELECT T.id_transaksi, 
    USR.NAMA_LENGKAP AS "NAMA PELAYAN", 
    T.NAMA_PELANGGAN, 
    T.TANGGAL AS WAKTU, 
    BR.NAMA_BRAND AS BRAND, 
    PH.NAMA_HANDPHONE AS MODEL, 
    PH.HARGA "HARGA PRODUK",
    BK.JUMLAH_KELUAR "JUMLAH BELI", 
    T.TOTAL_BAYAR "TOTAL HARGA" FROM TRANSAKSI T 
...
SELECT T.ID_TRANSAKSI, 
    ...
    PH.HARGA, 
    BK.JUMLAH_KELUAR, 
    SUM(PH.HARGA * BK.JUMLAH_KELUAR),
    T.TOTAL_BAYAR 
FROM TRANSAKSI T 
JOIN BARANG_KELUAR BK ON T.ID_TRANSAKSI = BK.ID_TRANSAKSI 
JOIN USERS USR ON T.ID_USER = USR.ID_USER 
JOIN PHONES PH ON BK.ID_PHONE = PH.ID_PHONE 
JOIN BRAND BR ON PH.ID_BRAND = BR.ID_BRAND group by T.ID_TRANSAKSI, USR.NAMA_LENGKAP, T.NAMA_PELANGGAN, T.TANGGAL, BR.NAMA_BRAND, 
